...
```
<img width="1502" height="225" alt="image" src="https://github.com/user-attachments/assets/bb20ec56-9f11-4863-8ba4-95452fa4ec9f" />
...
Searched for any indication the TOR browser was used to establish a connection using any of the known TOR ports. At `2025-09-16T18:27:36.9289152Z`, an employee on the "zee" device successfully established a connection to the remote IP address `193.108.53.121` on port `9001`. The connection was initiated by the process `tor.exe`, located in the folder `c:\users\zee\desktop\tor browser\browser\torbrowser\tor\tor.exe`. There were a couple of other connections to sites over port `443`.
...
- **Timestamp:** `2025-09-16T18:27:36.9289152Z`
- **Event:** A network connection to IP `193.108.53.121` on port `9001` by user "zeemakay" was established using `tor.exe`, confirming TOR browser network activity.
- **Action:** Connection success.
- **Process:** `tor.exe`
- **File Path:** `c:\users\zeemakay\desktop\tor browser\browser\torbrowser\tor\tor.exe`
